...
<head>
  ...
  <title>DevOps Software - Maftiyo</title>
...
<body>
  ...
  <main>
    ...
    <input type="text" id="search" placeholder="Search DevOps software..." class="search-bar">
    <div class="categories" id="softwareContainer">
      <?php foreach($software as $sw): if($sw['category'] == 'DevOps'): ?>
