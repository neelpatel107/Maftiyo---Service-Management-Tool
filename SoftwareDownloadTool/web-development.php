...
<head>
  ...
  <title>Web Development Software - Maftiyo</title>
...
<body>
  ...
  <main>
    <h2>Web Development Software</h2>
    <input type="text" id="search" placeholder="Search web development software..." class="search-bar">
    <div class="categories" id="softwareContainer">
      <?php foreach($software as $sw): if($sw['category'] == 'Web Development'): ?>
