...
<head>
  ...
  <title>3D Modeling Software - Maftiyo</title>
...
<body>
  ...
  <main>
    <h2>3D Modeling Software</h2>
    <input type="text" id="search" placeholder="Search 3D modeling software..." class="search-bar">
    <div class="categories" id="softwareContainer">
      <?php foreach($software as $sw): if($sw['category'] == '3D Modeling'): ?>
