...
<head>
  ...
  <title>Browser Software - Maftiyo</title>
...
<body>
  ...
  <main>
    ...
    <input type="text" id="search" placeholder="Search browser software..." class="search-bar">
    <div class="categories" id="softwareContainer">
      <?php foreach($software as $sw): if($sw['category'] == 'Browser'): ?>
