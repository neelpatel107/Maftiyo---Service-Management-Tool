...
<head>
  ...
  <title>Social Media Software - Maftiyo</title>
...
<body>
  ...
  <main>
    <h2>Social Media Software</h2>
    <input type="text" id="search" placeholder="Search social media software..." class="search-bar">
    <div class="categories" id="softwareContainer">
      <?php foreach($software as $sw): if($sw['category'] == 'Social Media'): ?>
