...
<head>
  ...
  <title>Game Development Software - Maftiyo</title>
...
<body>
  ...
  <main>
    <h2>Game Development Software</h2>
    <input type="text" id="search" placeholder="Search game development software..." class="search-bar">
    <div class="categories" id="softwareContainer">
      <?php foreach($software as $sw): if($sw['category'] == 'Game Development'): ?>
