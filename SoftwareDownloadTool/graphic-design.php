...
<head>
  ...
  <title>Graphic Design Software - Maftiyo</title>
...
<body>
  ...
  <main>
    ...
    <input type="text" id="search" placeholder="Search graphic design software..." class="search-bar" />
    <div class="categories" id="softwareContainer">
      <?php foreach($software as $sw): if($sw['category'] == 'Graphic Design'): ?>
