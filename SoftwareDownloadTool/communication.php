...
<head>
  ...
  <title>Communication Software - Maftiyo</title>
...
<body>
  ...
  <main>
    ...
    <input type="text" id="search" placeholder="Search communication software..." class="search-bar">
    <div class="categories" id="softwareContainer">
      <?php foreach($software as $sw): if($sw['category'] == 'Communication'): ?>
