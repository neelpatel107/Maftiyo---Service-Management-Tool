...
<head>
  ...
  <title>Data Analysis Software - Maftiyo</title>
...
<body>
  ...
  <main>
    ...
    <input type="text" id="search" placeholder="Search data analysis software..." class="search-bar">
    <div class="categories" id="softwareContainer">
      <?php foreach($software as $sw): if($sw['category'] == 'Data Analysis'): ?>
